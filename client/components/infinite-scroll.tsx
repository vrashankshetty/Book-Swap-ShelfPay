...
export default function InfiniteScrollBooks({ isManageable = false, initialBooks = [], pageSize = 8 }: BookGridProps) {
  const { toast } = useToast()
  const { getInfiniteMyBooks, deleteBook } = useBooks()
  ...
  const { data, error, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading, isError, refetch } =
    getInfiniteMyBooks(initialBooks, pageSize, searchTitle, selectedGenre=="Any"?"":selectedGenre, selectedCity=="Any"?"":selectedCity,selectedStatus=="Any"?"":selectedStatus)
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-lg border bg-card shadow-sm">
        <div className="p-6">
          <h2 className="text-2xl font-semibold mb-4">Find My Books</h2>
