...
export default function InfiniteSeekerScrollBooks({ isManageable = false, initialBooks = [], pageSize = 8 }: BookGridProps) {

  const { getInfiniteBooks } = useBooks()
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-lg border bg-card shadow-sm">
        <div className="p-6">
          <h2 className="text-2xl font-semibold mb-4">Seeker Dashboard</h2>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {allBooks.map((book: Book) => (
          ...
          >
            <Link href={`/seeker/books/${book.$loki}`}>
              <div className="relative">
                <Image
